def input_centre_letter() -> str:
    ...
    """
    centre_letter = input("Please enter the central letter: ").strip().lower()
...
def input_outer_letters() -> list:
    ...
    """
    outer_letters = input("Please enter the eight outer letters: ").strip().lower()
    outer_letters_list = []
    ...
    if len(outer_letters_list) == 8:
        ...
        raise ValueError(f"Invalid input: '{outer_letters}'. Please enter 8 letters.")
